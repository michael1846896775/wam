...
parser.add_argument(
    '--video_dir', 
    type=str, 
    default="./data/youzi_5/youzi_5/images", 
    help="Directory of the input video frames"
)

parser.add_argument(
    '--output_dir', 
    type=str, 
    default='./data/youzi_5/youzi_5/object_mask', 
    help="Directory where the object masks will be saved"
)
